...
const $c84c0bf239a66b7e$var$slider = new (0, $4e95c04dd8a5890d$export$25ce5a424b770e84)('.about-images__swiper', {
    modules: [
        (0, $3ede398f6665eb67$export$2e2bcd8739ae039),
        (0, $48396d89743015b3$export$2e2bcd8739ae039)
    ],
    navigation: {
        nextEl: '.about-images__swiper-wrapper-next',
        prevEl: '.about-images__swiper-wrapper-prev'
    },
    breakpoints: {
        1000: {
            slidesPerView: 4
...
document.addEventListener('DOMContentLoaded', function() {
    const dayButtons = document.querySelectorAll('.calc__item--day .calc__item-btn');
    const hourButtons = document.querySelectorAll('.calc__item--hour .calc__item-btn');
    const cards = document.querySelectorAll('.calc__card');
    function updateIncome() {
        const activeHourBtn = document.querySelector('.calc__item--hour .calc__item-btn--active');
        const activeDayBtn = document.querySelector('.calc__item--day .calc__item-btn--active');
        const sallary = parseInt(activeHourBtn.dataset.sallary || 0, 10);
        const premium = parseInt(activeHourBtn.dataset.premium || 0, 10);
        const days = parseInt(activeDayBtn.textContent.trim(), 10);
        const totalSallary = sallary * days;
        const totalPremium = premium * days;
        // Первая карточка — обычная зарплата
        const firstCard = cards[0].querySelector('.calc__price-num');
        firstCard.textContent = totalSallary.toLocaleString('ru-RU') + " \u20BD";
        // Вторая карточка — премиум
        const secondCard = cards[1].querySelector('.calc__price-num');
        secondCard.textContent = totalPremium.toLocaleString('ru-RU') + " \u20BD";
    }
    function setActive(btns, clickedBtn) {
        btns.forEach((btn)=>btn.classList.remove('calc__item-btn--active'));
        clickedBtn.classList.add('calc__item-btn--active');
        updateIncome();
    }
    dayButtons.forEach((btn)=>{
        btn.addEventListener('click', ()=>setActive(dayButtons, btn));
    });
    hourButtons.forEach((btn)=>{
        btn.addEventListener('click', ()=>setActive(hourButtons, btn));
    });
    updateIncome();
});
...
const $59ee7956de73cc3e$var$slider = new (0, $4e95c04dd8a5890d$export$25ce5a424b770e84)('.steps__swiper', {
    modules: [
        (0, $3ede398f6665eb67$export$2e2bcd8739ae039),
        (0, $48396d89743015b3$export$2e2bcd8739ae039),
    ...
    speed: 700,
    navigation: {
        nextEl: '.steps__swiper-wrapper-next',
        prevEl: '.steps__swiper-wrapper-prev'
    },
    slidesPerView: 1,
    loop: true
});
...
const $c9cb9c75a83c2c09$var$slider = new (0, $4e95c04dd8a5890d$export$25ce5a424b770e84)('.blog__swiper', {
    ...
    navigation: {
        nextEl: '.blog__swiper-wrapper-next',
        prevEl: '.blog__swiper-wrapper-prev'
    },
    pagination: {
...
document.addEventListener("DOMContentLoaded", ()=>{
    const accItems = document.querySelectorAll(".js-acc");
    accItems.forEach((item)=>{
        const head = item.querySelector(".js-acc__head");
        head.addEventListener("click", ()=>{
            // Если элемент уже активен, убираем модификатор
            if (item.classList.contains("js-acc--active")) {
                item.classList.remove("js-acc--active");
                return;
            }
            // Убираем модификатор со всех остальных элементов
            accItems.forEach((el)=>el.classList.remove("js-acc--active"));
 ...
 */ (function(window1) {
    ...
    $dc22438b41f9cca3$exports = mixitup;
...
const $48349179b0b4c1cd$var$containerEl = document.querySelector('.catalog__content');
const $48349179b0b4c1cd$var$containerElSecond = document.querySelector('.byuing-catalog__content');
if ($48349179b0b4c1cd$var$containerEl) (0, (/*@__PURE__*/$parcel$interopDefault($dc22438b41f9cca3$exports)))($48349179b0b4c1cd$var$containerEl, {
    selectors: {
        target: '.mix'
    },
    animation: {
...
if ($48349179b0b4c1cd$var$containerElSecond) {
    const mixer = (0, (/*@__PURE__*/$parcel$interopDefault($dc22438b41f9cca3$exports)))($48349179b0b4c1cd$var$containerElSecond, {
        selectors: {
            target: '.mix'
        },
        animation: {
    ...
    // После инициализации выбираем первую категорию, кроме "Все"
    mixer.show().then(()=>{
        // Найди все кнопки фильтра
        const filterButtons = document.querySelectorAll('[data-filter]');
        // Пропускаем "Все" (обычно [data-filter="all"] или "*")
        const firstCategoryBtn = Array.from(filterButtons).find((btn)=>btn.getAttribute('data-filter') !== 'all' && btn.getAttribute('data-filter') !== '*');
        if (firstCategoryBtn) {
            const filterValue = firstCategoryBtn.getAttribute('data-filter');
            mixer.filter(filterValue);
            // Устанавливаем активный класс (если используется)
            filterButtons.forEach((btn)=>btn.classList.remove('mixitup-control-active'));
            firstCategoryBtn.classList.add('mixitup-control-active');
        }
    });
}
...
ymaps.ready(function() {
    ...
    var balloonContent = `
        <div class="custom-balloon">
          <h3>\u{423}\u{441}\u{442}\u{430} \u{2014} \u{430}\u{432}\u{442}\u{43E}\u{441}\u{435}\u{440}\u{432}\u{438}\u{441}, \u{430}\u{432}\u{442}\u{43E}\u{446}\u{435}\u{43D}\u{442}\u{440}</h3>
          <p class="working-hours">\u{41E}\u{442}\u{43A}\u{440}\u{44B}\u{442}\u{43E} \u{434}\u{43E} 21:00</p>
          <p>\u{41C}\u{43E}\u{441}\u{43A}\u{432}\u{430}, \u{41A}\u{430}\u{43B}\u{443}\u{436}\u{441}\u{43A}\u{43E}\u{435} \u{448}\u{43E}\u{441}\u{441}\u{435}, 4\u{410}</p>
          <div class="contact">
            <b>8 (915) 395-53-83</b><br>
            <a href="http://VNK-TAXI.ru" target="_blank">VNK-TAXI.ru</a>
          </div>
          <div class="landmarks">
            \u{420}\u{430}\u{43A}\u{438}\u{442}\u{43A}\u{438} \u{2014} 85 \u{43C}<br>
            \u{41E}\u{437}\u{434}\u{43E}\u{440}\u{43E}\u{432}\u{438}\u{442}\u{435}\u{43B}\u{44C}\u{43D}\u{44B}\u{439} \u{43A}\u{43E}\u{43C}\u{43F}\u{43B}\u{435}\u{43A}\u{441} \u{414}\u{435}\u{441}\u{43D}\u{430} \u{2014} 193 \u{43C}<br>
            \u{420}\u{44F}\u{431}\u{438}\u{43D}\u{43E}\u{432}\u{430}\u{44F} \u{443}\u{43B}\u{438}\u{446}\u{430} \u{2014} 2,06 \u{43A}\u{43C}
          </div>
        </div>
      `;
